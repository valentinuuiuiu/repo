...
exports.ProviderType = exports.BaseProvider = exports.ProviderConfigSchema = void 0;
...
var BaseProvider = /** @class */ (function () {
    function BaseProvider(config) {
        this.config = exports.ProviderConfigSchema.parse(config);
    }
    // Optional method for streaming responses
    BaseProvider.prototype.streamChat = function (messages) {
        return __asyncGenerator(this, arguments, function streamChat_1() {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, __await(this.chat(messages))];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, __await(response.content)];
    ...
    BaseProvider.prototype.validateConfig = function (config) {
        exports.ProviderConfigSchema.parse(config);
    };
    return BaseProvider;
}());
...
(function (ProviderType) {
    ...
    ProviderType["MISTRALAI"] = "mistralai";
